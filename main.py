...
parser.add_argument("--first_decay_steps_alpha", type=int, default=375, help="first period decay of learning rate steps for alpha training")#400
...
parser.add_argument("--num_epochs_alpha", type=int, default=30, help="alpha number of epochs")#256
