...
parser.add_argument("--first_decay_steps_alpha", type=int, default=6400, help="first period decay of learning rate steps for alpha training")#400
...
parser.add_argument("--num_epochs_alpha", type=int, default=512, help="alpha number of epochs")#256
...
if __name__ == '__main__':
    ...
    # calc_term_fund_allocations(args,invest_horizon = 15)
